<template>
     <div @click="openPage()" class="w-64 max-sm:w-48 hover:scale-95 transition-all bg-[var(--card-color)] shadow-2xl border p-1 flex justify-center flex-col rounded-md">
