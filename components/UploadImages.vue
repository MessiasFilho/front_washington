        ...
        <DialogContent  class="h-96 rounded-md">
            <DialogHeader>
                <div class="flex justify-between items-center">
                    ...
                    <div @click="use_modal.upload = false , images = []" class="cursor-pointer active:scale-90">
...
const filesList = usePoster().files
