    ...
    <div class="flex bg-[#030c1a] flex-col items-center justify-center px-2">
      <div v-if="imageUrl == null" class="">
       ...
       <div class="flex my-3 rounded-md p-2 flex-col w-full bg-[#112037] ">
              ...
              <span> Descrição</span>
              <textarea v-model="inform.description" class="outline-none text-black rounded-sm p-1 shadow-md h-20"></textarea>       
       ...
       <div class="mb-2 flex w-full  justify-end space-x-3">
         ...
         <button :disabled="valid" :class="!valid ? false:'bg-blue-950 active:scale-100 transition-all' "  @click="clickConfirm()" class="active:scale-95 px-4 py-1 bg-blue-500 text-white rounded uppercase">confirmar</button>
       </div>
    </div>
</template>
