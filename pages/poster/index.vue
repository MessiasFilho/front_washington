    ...
    <div class="flex bg-[#030c1a] flex-col items-center justify-center px-2">
      <div v-if="imageUrl == null" class="">
       ...
       <div class="flex my-3 rounded-md p-2 flex-col w-full bg-[#112037] ">
        ...
        <button @click="use_modal.upload = true" class="p-1 space-x-3 flex justify-center items-center bg-green-600 mt-3 rounded-xl active:scale-95">
            <div>
       ...
       <div class="mb-2 flex w-full  justify-end space-x-3">
         ...
         <button @click="" class="active:scale-95 px-4 py-1 bg-blue-500 text-white rounded uppercase">confirmar</button>
       </div>
    </div>
</template>
